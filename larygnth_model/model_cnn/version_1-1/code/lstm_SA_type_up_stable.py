...
class LSTM_SA_Tester():
    ...
    def test(self, batch_size=1, save_validate_image=False):
        ...
        sio.savemat(path, {"lstm_sa_up_normal_load_batch":_runtime_load_batch,
                            "lstm_sa_up_normal_feedforward_batch":_runtime_feedforward_batch,
                            "lstm_sa_up_normal_save_batch":_runtime_save_batch})
...
class LSTM_SA_Tester_MidSeq():
    ...
    def test(self, save_validate_image=False):
        ...
        path = self._output_path + "runtime.mat"
        sio.savemat(path, {"lstm_sa_up_midseq_load_batch":_runtime_load_batch,
                            "lstm_sa_up_midseq_feedforward_batch":_runtime_feedforward_batch,
                            "lstm_sa_up_midseq_save_batch":_runtime_save_batch})
